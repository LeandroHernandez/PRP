...
export class AdminEducationalUnitService {
  ...
  constructor(private db: AngularFirestore) {
    this.adminEducationalUnitCollection =
      this.db.collection<UnitEducational>("cuenca");
  }
  ...
  public getGradesFromUnitEducational(unitEducationalId: String) {
    const collectionGrades = this.db
      .collection("cuenca")
  ...
  /**
   * OBTENER LISTADO DE GRADOS
   */

  public getGrades() {
    const collectionGrades = this.db.collection("grades", (ref) =>
      ref.where("grade_status", "==", true)
    );
    if (collectionGrades) {
      return collectionGrades.valueChanges();
    }
  ...
  /** OBTENER LISTADO DE PARALELOS DE UNIDAD EDUCATIVA */
  public getParallelsFromUnitEducational(
    gradeId: string,
    unitEducationalId: String
  ): Observable<firebase.firestore.DocumentData[]> {
    const collectionParallels = this.db
      .collection("cuenca")
      .doc(`${unitEducationalId}`)
      .collection("parallels", (ref) =>
        ref.where("parallel_status", "==", true)
      );
    if (collectionParallels) {
      return collectionParallels.valueChanges();
    }
  ...
  public getParallelsFromStudent(unitEducationalId: String) {
    return this.db
      .collection("student", (ref) =>
        ref.where("student_unit_educational", "==", unitEducationalId)
      )
      .valueChanges();
  }
  /**
   ...
   */
  public getStudentsFromEducationalUnit(unitEducationalId: String) {
    const collectionStudents = this.db
      .collection("student", (ref) =>
        ref.where("student_unit_educational", "==", unitEducationalId)
      )
      .valueChanges();
   ...
   * @param gradeId
   */
  public getGradeByGradeId(gradeId: string, unitEducationalId: String) {
    return this.db
      .collection("cuenca")
      .doc(`${unitEducationalId}`)
      .collection("grades")
   ...
   * @param parallelId
   */
  public getParallelByParallelId(
    parallelId: String,
    unitEducationalId: String
  ) {
    return this.db
   ...
   */
  public updateStudent(student: Student, data) {
    const collectionStudent = this.db
      .collection("student")
   ...
   * @param parallelId
   */
  public getStudentsAssignedToGrade(
    unitEducationalId: String
  ): Observable<unknown[]> {
    return this.db
      .collection("student", (ref) =>
   ...
   * @param unitEducationalId
   */
  public getSubjectsFromEducationalUnit(
    unitEducationalId: String,
    sublevelId: String
  ) {
    return this.db
  ...
  public saveTeacherAssignSubject(
    teacher: Teacher,
    unitEducationalId: String,
    subject: Subject,
    parallel: Parallels
   ...
   * @param parallel
   */
  public addParallelIdInTeacherCollection(
    teacher: Teacher,
    parallel: Parallels,
    unitEducationalId: String
  ) {
  ...
  public getSubjectTeachers(
    ...
    return this.db
      ...
      .collection("parallels")
      .doc(`${parallelId}`)
      .collection("subjects", (ref) => ref.where("subject_id", "==", subjectId))
      .valueChanges();
  }
   ...
   * @param subject
   */
  public deleteTeacherFromSubject(
    teacher: Teacher,
    unitEducationalId: String,
    parallels: Parallels,
    subject: Subject
  ) {
    const collectionSubjectInTeacher = this.db
      .collection("teacher")
      .doc(`${teacher.teacher_id}`)
      .collection("unit_educational")
      .doc(`${unitEducationalId}`)
      .collection("parallels")
      .doc(`${parallels.parallel_id}`)
      .collection("subjects")
      .doc(`${subject.subject_id}`);
    if (collectionSubjectInTeacher) {
      collectionSubjectInTeacher.delete();
  ...
  public unitsFromUE(ue, parallel, subject) {
    const docRef = this.db
      .collection("cuenca")
      .doc(ue)
      .collection("planification")
  ...
  public sessionsFromUnit(ue, parallel, subject, unit) {
    const docRef = this.db
      .collection("cuenca")
      .doc(ue)
      .collection("planification")
  ...
  public evaluationsFromSession(ue, parallel, subject, unit, session) {
    const docRef = this.db
      .collection("cuenca")
      .doc(ue)
      .collection("planification")
