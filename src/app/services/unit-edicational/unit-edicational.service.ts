...
export class UnitEdicationalService {
   ...
   */
  public async saveUnitEducational(
    unitEducational: UnitEducational,
    isNew: boolean
  ) {
    const collection: AngularFirestoreCollection<UnitEducational> =
      this.db.collection<UnitEducational>(
        unitEducational.unit_educational_city.toLowerCase()
      );
  ...
  public async deleteUnitEducational(
    unitEducationalId: string,
    city: string
  ): Promise<void> {
    const collection: AngularFirestoreCollection<UnitEducational> =
      this.db.collection<UnitEducational>(city.toLowerCase());
   ...
   * @param sublevels
   */
  async saverLevelsUnitEducational(
    unitEducational: UnitEducational,
    levels: Level[],
    sublevels: SubLevels[],
    grades: SchoolGrade[],
   ...
   * @param level
   */
  public changeStateLevelUnitEducational(
    unitEducational: UnitEducational,
    level: Level,
    period
  ) {
    const levelUpdate = this.db
      .collection<UnitEducational>(
        unitEducational.unit_educational_city.toLowerCase()
      )
      .doc(unitEducational.unit_educational_id)
   ...
   * @param grade
   */
  public changeStateGradeUnitEducational(
    unitEducational: UnitEducational,
    grade: SchoolGrade,
    period
  ) {
    const collectionGrade = this.db
      .collection<UnitEducational>(
        unitEducational.unit_educational_city.toLowerCase()
      )
      .doc(unitEducational.unit_educational_id)
  ...
  public changeStateParallelUnitEducational(
    ...
    const collectionParallel = this.db
      .collection<UnitEducational>(
        unitEducational.unit_educational_city.toLowerCase()
      )
      .doc(unitEducational.unit_educational_id)
   ...
   * @param academy_area
   */
  public changeStateAcademyAreaUnitEducational(
    unitEducational: UnitEducational,
    academy_area: Academyareadocum,
    period
  ) {
    const collectionAcademyArea = this.db
      .collection<UnitEducational>(
        unitEducational.unit_educational_city.toLowerCase()
      )
      .doc(unitEducational.unit_educational_id)
  ...
  public NewChangeStateAcademyAreaUnitEducational(
    unitEducational: UnitEducational,
    academy_area: Academyareadocum,
    state: boolean
  ) {
   ...
   * @param state
   */
  public changeStateSubjectUnitEducational(
    unitEducational: UnitEducational,
    subject: Subject,
    period: any
  ) {
    const collectionSubject = this.db
      .collection<UnitEducational>(
        unitEducational.unit_educational_city.toLowerCase()
      )
      .doc(unitEducational.unit_educational_id)
  ...
  public NewChangeStateSubjectUnitEducational(
    unitEducational: UnitEducational,
    subject: Subject,
    state: boolean
  ) {
  ...
  public getGrades(
    unit_educational: string,
    grade_id: string,
    period: any
  ): Observable<any> {
    return this.levelCollection
      .doc(`${unit_educational}`)
      .collection("PeriodosLectivos")
      .doc(period)
      .collection<SchoolGrade>("grades")
      .doc(`${grade_id}`)
      .valueChanges();
  }

  public getSubjectBySublevelId(
    unit_educational: string,
    sublevel_id: string,
    period: any
  ): Observable<any> {
    return this.levelCollection
      ...
      .collection("subjects", (ref) =>
        ref.where("sublevel_id", "==", `${sublevel_id}`)
      )
      .valueChanges();
  }
  ...
  getSubjectUnits(activeStudent, activeSubject, period) {
    return this.levelCollection
      .doc(
        `${activeStudent.student_unit_educational}/PeriodosLectivos/${period}/planification/planification_parallels/parallels/${activeStudent.student_parallel_id}/subjects/${activeSubject.subject_id}`
      )
      .collection("units")
      .valueChanges();
  }
  ...
  getClassFromUnit(activeStudent, activeSubject, activeUnit, period) {
    ...
    return this.levelCollection
      .doc(
        `${activeStudent.student_unit_educational}/PeriodosLectivos/${period}/planification/planification_parallels/parallels/${activeStudent.student_parallel_id}/subjects/${activeSubject.subject_id}/units/${activeUnit.unit_id}`
      )
      .collection("classes", (ref) => ref.orderBy("fromDate", "desc"))
      .valueChanges();
  }
