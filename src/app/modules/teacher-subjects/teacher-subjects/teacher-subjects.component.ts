...
export class TeacherSubjectsComponent implements OnInit, OnDestroy {
  ...
  public getParallelsFromTeacher(teacher: Teacher) {
    ...
    this.parallelsSubscription = this.ts.getParallelsFromTeacherId(this.selectedTeacher.teacher_id, unitEducationalId, this.academicPeriodStorage[0].academic_year_name)
  ...
  public getSubjectsFromTeacher(parallel) {
    ...
    this.subjectSubscription = this.ts.getSubjectsFromParallelIid(this.selectedTeacher.teacher_id, unitEducationalId, parallel, this.academicPeriodStorage[0].academic_year_name)
        .subscribe(subjects => {
