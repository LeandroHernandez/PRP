...
import {InformationEvaluationQuestion} from '../../../../models/class/class.document-informationPracticeQuestion';
import {EvaluationSummary} from '../../../../models/class/evaluation-summary';
...
@Component({
  selector: 'app-evaluation-simulator',
  templateUrl: './evaluation-simulator.component.html',
  styleUrls: ['./evaluation-simulator.component.css']
})
export class EvaluationSimulatorComponent implements OnInit {
  ...
  public saveSummaryEvaluation() {
    ...
    swal({
      title: 'Haz finalizado la simulación de evaluación!',
