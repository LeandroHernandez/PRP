...
export class ListeducationalunitComponent implements OnInit {
  ...
  constructor(private educationalunitService: EducationalUnitService) {}
  ...
  load_data_table_pagination(data) {
    this.displayedColumns = [
      "educational_unit_id",
      "educational_unit_logo",
      "educational_unit_name",
      "educational_unit_email",
      "educational_unit_number_of_students",
      "educational_unit_telephone",
      "option",
    ];
